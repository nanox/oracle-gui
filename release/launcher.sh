...
ORACLE_GUI_JAR_DIR= "./" 
#"/home/sabuj/SVN_HOME/oracle-gui/trunk/release/Oracle-GUI-1.0-beta-1"
...
$_JAVA_EXEC -Xmx${MAXIMUM_HEAP_SIZE} -Dsmartsvn.vm-xmx=${MAXIMUM_HEAP_SIZE} -jar "$ORACLE_GUI_JAR_DIR/$ORACLE_GUI_JAR_NAME" "$@"
