...
import com.gs.dbex.application.comps.MenuBarItems;
import com.gs.dbex.application.comps.SqlQueryPanel;
import com.gs.dbex.application.comps.TableContentPanel;
import com.gs.dbex.application.comps.TableDetailsPanel;
			...
			if(NEW_CONNECTION_ACT_CMD.equals(cmd)){
				...
				Runnable connRun = new Runnable(){
					...
					public void run() {
						...
						DbexApplicationMainFrame frame = (DbexApplicationMainFrame) parent;
						...
						if(conn != null){
							...
							((DbexApplicationMainFrame)parent).getMainDesktopPane().add(iFrame);
				...
				DbexApplicationMainFrame f = (DbexApplicationMainFrame) getParent();
