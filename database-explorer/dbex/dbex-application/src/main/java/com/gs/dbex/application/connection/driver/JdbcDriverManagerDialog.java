...
public class JdbcDriverManagerDialog extends JDialog implements ActionListener,
	...
	public static final ImageIcon DRIVER_ICON = new ImageIcon(
			JdbcDriverManagerDialog.class
					.getResource(DRIVER_MGR_IMG_LOC + DRIVER_IMG_NAME));
	...
	private void initComponents() {
		...
		defaultValuePanel.setBorder(BorderFactory
				.createTitledBorder(" Default Values"));
	...
	private void loadDriver(File selectedFile) {
		...
		topNode.add(new DefaultMutableTreeNode(
				new IconData(DRIVER_ICON, null, "com.sun.jdbc.Driver")));
		topNode.add(new DefaultMutableTreeNode(
				new IconData(DRIVER_ICON, null, "com.sun.jdbc.JdbcDriver")));
